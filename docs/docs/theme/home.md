...
- frontmatter 配置：
  ...
  - socialLinks：社交地址，社交 icon 请到 [Xicons](https://www.xicons.org/#/zh-CN) 页面的 tabler、fa、material 下获取，复制名称即可
    - icon: 图标
    - link: 按钮地址
- 案例：
...
blog: # blog 模块的配置
  socialLinks: # 社交 icon 请到 [Xicons](https://www.xicons.org/#/zh-CN) 页面的 tabler、fa、material 下获取，复制名称即可
